...
Посмотреть, как работает память, можно в [Memory.java](https://github.com/unidok/justmc-jvm/blob/master/justmc-jdk/src/main/java/justmc/Memory.java)

### Java
Java максимально урезана из-за её большого размера, поэтому из неё можно использовать только самую базу: java.lang, java.util и т.п.
