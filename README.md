...
> ⚠️ Большинство native-методов из Java не будут реализованы по причине того, что такой возможности нет на JustMC.
...
### Примитивы
<details>
    <summary><i>Нажмите, чтобы прочитать предупреждение и подробности</i></summary>
...
#### Передача структуры как аргумент
